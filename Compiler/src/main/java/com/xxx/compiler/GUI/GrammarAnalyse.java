//package com.xxx.compiler.GUI;
//
//import com.xxx.compiler.Parser.SearchTables;
...
//    private ArrayList<String> procNameList;
//    private int j;
//    private Word word;
...
//                        if(SearchTables.searchExits(tables,j,procNameList.get(procNameList.size()-1),name)==0){
//                            System.out.println("标识符"+name+"已存在");
//                            return 0;
//                        }
//                        tables.add(new Table(name,1,j,0,procNameList.get(procNameList.size()-1)));
//                        word=getSym();
